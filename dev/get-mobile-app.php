<?php include('components/header.php'); ?>
		<div>
			...
			<section class="l-band gravity-app u-black">
				<div class="l-contain">
					<div class="l-half-left">
						...
						<div class="header-btns l-contain">
						<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" class="paypal_form_btn header-paypal_form_btn">
			...
			<div class="l-contain mobile-home-gravity-image">
				<img src="i/mobileimages/header_mobile_getmobileapp.jpg">
			</div>
			<section class="l-band u-white c-mobile-app edge--both--reverse">
				<div class="l-contain">
					<section class="l-thirds l-contain app-items">
						...
						<div class="u-text-align-center app-item">
								...
								<h3>Community-Driven Inspiration</h3>
								<p>Share your progress with friends and colleagues. Follow others and challenge one another to stay healthy, fit and motivated.</p>
						</div>
					</section>
					<section class="mobile-app-screenshots l-contain">
						<div class="l-half-left">
							<img src="i/delivery_2_b.png">
						</div>
						<div class="l-half-right">
							<img src="i/delivery_3_b.png">
						</div>
					</section>
				</div>
			</section>
